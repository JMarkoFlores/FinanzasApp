...
def mostrar_calculadora_bonos():
    ...
    vp_bono, cupon_calc = calcular_valor_presente_bono(valor_nominal, tasa_cupon, tiempo, tea, periodo)
    ...
    periodos = list(range(0, tiempo + 1))
    flujos = []
    flujos_actualizados = []
    vp_acumulado = []
    
    tasa_descuento = convertir_tea_a_periodo(tea, periodo)
    ...
    for t in periodos:
        if t == 0:
            ...
            vp_acum = vp_acumulado[-1] + flujo_actualizado
        else:
